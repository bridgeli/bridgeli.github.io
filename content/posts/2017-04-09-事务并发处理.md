...
![第一类丢失更新](http://om2v5fbz2.bkt.clouddn.com/first_lost_update.png) 

②. dirty read脏读(读到了另一个事务在处理中还未提交的数据)

![脏读](http://om2v5fbz2.bkt.clouddn.com/dirty_read.png) 

③. non-repeatable read 不可重复读

![不可重复读](http://om2v5fbz2.bkt.clouddn.com/non_repeatable_read.png) 

④. second lost update problem 第二类丢失更新(不可重复读的特殊情况)

![第二类丢失更新](http://om2v5fbz2.bkt.clouddn.com/second_lost_update.png) 

⑤. phantom read 幻读

![幻读](http://om2v5fbz2.bkt.clouddn.com/phantom_read.png) 
