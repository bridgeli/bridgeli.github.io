        ...
        <table width="960" border="0" align="center">
            <tr>
                <td width="536" valign="top">
                    <form action="${pageContext.request.contextPath}/servlet/yeepay/PaymentRequestServlet" method="post"name="paymentform">
...
```
p1_MerId=YOUR_MERCHANT_ID
keyValue=YOUR_MERCHANT_SECRET_KEY
