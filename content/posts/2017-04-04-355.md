...
![](http://om2v5fbz2.bkt.clouddn.com/JConsole_start.jpg) 

进入JConsole主界面，有“概述”、“内存”、“线程”、“类”、“VM摘要”和"Mbean"六个页签：

![](http://om2v5fbz2.bkt.clouddn.com/JConsole_process.jpg) 

内存页签相当于jstat命令，用于监视收集器管理的虚拟机内存(Java堆和永久代)变化趋势，还可在详细信息栏观察全部GC执行的时间及次数

![](http://om2v5fbz2.bkt.clouddn.com/JConsole_mem.jpg) 

线程页签：线程长时间停顿的主要原因有：等待外部资源（数据库连接、网络资源、设备资源等）、死循环、锁等待（活锁和死锁）

![](http://om2v5fbz2.bkt.clouddn.com/JConsole_thread.jpg) 

最后一个常用页签，VM页签，可清楚的了解显示指定的JVM参数及堆信息

![](http://om2v5fbz2.bkt.clouddn.com/JConsole_jntro.jpg) 
...
![](http://om2v5fbz2.bkt.clouddn.com/Visual_GC.png) 
